# Graphical time-delay visualisation
...
![Below-threshold sound](nosound.PNG width=50% height=50%)

![Sound from the left](sound_left.PNG width=50% height=50%)

![Sound from the right](sound_right.PNG width=50% height=50%)
